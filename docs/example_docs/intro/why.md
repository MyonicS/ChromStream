...
The first question to address is: why? Why use a chromstream repository like this? Why make a Python package at all, as opposed to writing custom scripts or Jupyter Notebooks?
...
This is by no means the only chromstream of its kind. Some alternatives include:
...
- [python-package-chromstream](https://github.com/microsoft/python-package-chromstream)

... and many more.

Feel free to use them if you wish! This chromstream repository exists because we are all opinionated people, and this chromstream focuses on things that I value most. But the point is to just use something that works well for you.
